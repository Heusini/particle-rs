...
pub struct Pins {
    ...
    pub p0_16: Option<p0::P0_16<gpio::Input<gpio::Floating>>>, // P0.16 connect to BOOT_MODE
    pub p0_24: Option<p0::P0_24<gpio::Input<gpio::Floating>>>, // P0.24 connect to WIFI_EN
    pub p1_04: Option<p1::P1_04<gpio::Input<gpio::Floating>>>, // P1.04 connects to txd
    pub p1_05: Option<p1::P1_05<gpio::Input<gpio::Floating>>>, // P1.05 connects of rxd
    pub p1_06: Option<p1::P1_06<gpio::Input<gpio::Floating>>>, // argon P1.06 connects to rts of esp
    pub p1_07: Option<p1::P1_07<gpio::Input<gpio::Floating>>>, // argon P1.07 connects to cts of esp
}
...
impl Pins {
    pub fn new(p0: nrf52840_hal::pac::P0, p1: nrf52840_hal::pac::P1) -> Self {
        ...
        Self {
            ...
            p0_16: Some(pins0.p0_16.into_floating_input()),
            p0_24: Some(pins0.p0_24.into_floating_input()),
            p1_04: Some(pins1.p1_04.into_floating_input()),
            p1_05: Some(pins1.p1_05.into_floating_input()),
            p1_06: Some(pins1.p1_06.into_floating_input()),
            p1_07: Some(pins1.p1_07.into_floating_input()),
        }
    }
}
